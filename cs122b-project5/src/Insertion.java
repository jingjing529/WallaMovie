...
public class Insertion {
    ...
    private String loginPasswd = "mypassword";
    private String loginUrl = "jdbc:mysql://mpri.wallamovie.store:3306/moviedb";
...
//                    System.out.println("Movie not found: " + movieId);
    ...
    public void saveNotFoundDataToFile() {
        ...
        try {
            PrintWriter writer = new PrintWriter("/home/ubuntu/s23-122b-wjj/cs122b-project5/xml/errorReport.txt", "UTF-8");
