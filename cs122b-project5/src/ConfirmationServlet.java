...
public class ConfirmationServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        Map<String,Integer> SalesId = (Map<String,Integer>) session.getAttribute("salesId");
        JsonArray jsonArray = new JsonArray();
        JsonObject jsonObject = new JsonObject();
        for (String key: SalesId.keySet()) {
            jsonObject.addProperty(key, SalesId.get(key));
            System.out.println(key);
            System.out.println(SalesId.get(key));
        }
...
//        System.out.println("it's in ConfirmationServlet");
////
